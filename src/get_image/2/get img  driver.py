...
日期 = driver.find_element_by_id('toTimeInputField').send_keys('2019/11/29')
...
#-----------------------------------------------------
with open('get_image/2/lebal/lebal2.csv', mode='w', encoding='utf-8') as write_file:
    ...
    while( count <= 5000):
        ...
        try:
            ...
            with open('get_image/2/img/'+str(count)+'.jpg', 'wb') as file:
                file.write(get_img.content)
                file.flush()
